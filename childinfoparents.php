...
echo '<table width="300" border="0" class="table">';
  echo '<tr><td><a href="/parentinfo.php?passedParentID=', $row_Sort2['ParentID'], '"><img width="125" src = "/ParentPictures/', $row_Sort2['ParentID'], '.jpg"></a></td>';
  echo '<td>';
  echo '<table width="300" border="0" class="table">';
    //echo '<tr><td colspan="5">', $row_Sort2['FirstName'], ' ', $row_Sort2['LastName'], '</td></tr>';
    if($row_Sort2['CellPhone1']<7){echo '<tr><td><b>NO CELL #</b></td>';}else{echo '<tr>';}
    if($row_Sort2['ChildID1']!=''){echo '    <td><a href="/childinfo.php?passedChildID=', $row_Sort2['ChildID1'], '"><img width="75" src = "/ChildPictures/', $row_Sort2['ChildID1'], '.jpg"></a></td>';}
    if($row_Sort2['ChildID2']!=''){echo     '<td><a href="/childinfo.php?passedChildID=', $row_Sort2['ChildID2'], '"><img width="75" src = "/ChildPictures/', $row_Sort2['ChildID2'], '.jpg"></a></td>';}
    if($row_Sort2['ChildID3']!=''){echo     '<td><a href="/childinfo.php?passedChildID=', $row_Sort2['ChildID3'], '"><img width="75" src = "/ChildPictures/', $row_Sort2['ChildID3'], '.jpg"></a></td>';}
    if($row_Sort2['ChildID4']!=''){echo     '<td><a href="/childinfo.php?passedChildID=', $row_Sort2['ChildID4'], '"><img width="75" src = "/ChildPictures/', $row_Sort2['ChildID4'], '.jpg"></a></td></tr>';}else{echo '</tr>';}
    
    //if($row_Sort2['ChildID5']!=''){echo     '<td><a href="/childinfo.php?passedChildID=', $row_Sort2['ChildID5'], '"><img width="75" src = "/ChildPictures/', $row_Sort2['ChildID5'], '.jpg"></a></td></tr>';}else{echo '</tr>';}
    //if($row_Sort2['ChildID6']!=''){echo '<tr><td><a href="/childinfo.php?passedChildID=', $row_Sort2['ChildID6'], '"><img width="75" src = "/ChildPictures/', $row_Sort2['ChildID6'], '.jpg"></a></td>';}
    //if($row_Sort2['ChildID7']!=''){echo     '<td><a href="/childinfo.php?passedChildID=', $row_Sort2['ChildID7'], '"><img width="75" src = "/ChildPictures/', $row_Sort2['ChildID7'], '.jpg"></a></td>';}
    //if($row_Sort2['ChildID8']!=''){echo     '<td><a href="/childinfo.php?passedChildID=', $row_Sort2['ChildID8'], '"><img width="75" src = "/ChildPictures/', $row_Sort2['ChildID8'], '.jpg"></a></td>';}
    //if($row_Sort2['ChildID9']!=''){echo     '<td><a href="/childinfo.php?passedChildID=', $row_Sort2['ChildID9'], '"><img width="75" src = "/ChildPictures/', $row_Sort2['ChildID9'], '.jpg"></a></td>';}
    //if($row_Sort2['ChildID10']!=''){echo    '<td><a href="/childinfo.php?passedChildID=', $row_Sort2['ChildID10'], '"><img width="75" src = "/ChildPictures/', $row_Sort2['ChildID10'], '.jpg"></a></td></tr>';}else{echo '</tr>';}
  echo '</table>';  
