   <table width="480" height="240"  border="0" class="table" >
      <tr>
        <td colspan="2" align="left"><?php echo '<img width="120" src="/ParentPictures/', $row_Sort['ParentID'], '.jpg">';?></td>
      ...
      <tr>
	<?php if($row_Sort['ChildID1']!=''){echo '<td colspan="2"><img width="120" src="/ChildPictures/',$row_Sort['ChildID1'],'.jpg"></td>';}else {echo '&nbsp;';} ?>
	<?php if($row_Sort['ChildID2']!=''){echo '<td colspan="2"><img width="120" src="/ChildPictures/',$row_Sort['ChildID2'],'.jpg"></td>';}else {echo '&nbsp;';} ?>
	<?php if($row_Sort['ChildID3']!=''){echo '<td colspan="2"><img width="120" src="/ChildPictures/',$row_Sort['ChildID3'],'.jpg"></td>';}else {echo '&nbsp;';} ?>
	<?php if($row_Sort['ChildID4']!=''){echo '<td colspan="2"><img width="120" src="/ChildPictures/',$row_Sort['ChildID4'],'.jpg"></td>';}else {echo '&nbsp;';} ?>
      </tr>
      <tr>
